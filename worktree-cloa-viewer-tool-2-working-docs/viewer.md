...
obey the [Contract](/worktree-cloa-viewer-tool-2-working-docs/contract.md);
...
pin. The arrangement
([Contract](/worktree-cloa-viewer-tool-2-working-docs/contract.md#the-arrangement))
...
([Server](/worktree-cloa-viewer-tool-2-working-docs/server.md#the-command)),
