...
the conversation settled on. It is the theory half of this set; the
viewer pages, from
[CLOA Viewer](/worktree-cloa-viewer-tool-2-working-docs/ROOT.md) down,
are the delivery. **Where the viewer pages, or anything elsewhere in
