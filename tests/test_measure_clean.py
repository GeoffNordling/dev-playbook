...
Each test is about what one technique removes, so the frames come from
`measure_fakes` — the shared builder that produces the loader's own shape.
"""
...
from dev_playbook.measure import clean
