"""TEMPORARY: the four pseudocode blocks match the reference model's one.

The doc-type system's pseudocode is split across four pages, the base in
...
def test_the_four_pages_concatenated_are_the_reference_models_block() -> None:
