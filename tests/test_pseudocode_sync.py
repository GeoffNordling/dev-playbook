"""The six pseudocode blocks match the reference model's one.
...
reference model, `doc-types/reference-model.md`, holds the same text
whole. This test fails when they differ. It parses nothing as Python:
the pseudocode is a picture, not code. Delete this test when the
