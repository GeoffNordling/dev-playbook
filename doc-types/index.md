...
repo's instantiation, and one directory per built doc-type. The theory
and the target state are the working set's
...
- [explanation/](/doc-types/explanation/index.md) — The Explanation doc-type — definition, contract shape, encoding, and residual ledger for the Reasons beside each Standard
- [guide/](/doc-types/guide/index.md) — The Guide doc-type — definition, contract shape, encoding, and residual ledger for the documents under guides/
