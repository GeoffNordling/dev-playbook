...
Entries name the frontmatter and the trailer in the vocabulary
...
else. A Guide with nothing to record has no entry. No Guide is checked
against the encoding yet, so the ledger holds none.
