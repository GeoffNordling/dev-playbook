...
- [Acts, Checks, and Yields](/doc-types/loop/contract-shape.md) — Loop's contract shape — acts, checks, and yields, one ordered list of steps, iterated — in prose, one screen of pseudocode, and the graph every Loop is drawn as
