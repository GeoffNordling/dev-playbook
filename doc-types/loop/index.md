...
- [Acts, Checks, and Yields](/doc-types/loop/contract-shape.md) — Loop's contract shape — acts, checks, and yields, one ordered list of steps, iterated — in prose, and the graph every Loop is drawn as
