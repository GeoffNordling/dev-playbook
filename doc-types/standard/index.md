...
- [Cells and Rulesets](/doc-types/standard/contract-shape.md) — Standard's contract shape — four cells, one per verb, each a pointer list, with the ruleset a Define pointer reaches, one population and its rules — in prose, and the relations every Standard collapses to
