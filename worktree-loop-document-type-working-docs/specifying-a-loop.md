...
A **predicate** is defined in [Glossary](/worktree-loop-document-type-working-docs/glossary.md), and
[Writing Predicates](/worktree-loop-document-type-working-docs/writing-predicates.md#the-litmus) holds the
