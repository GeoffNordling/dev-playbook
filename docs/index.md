...
- [Hook capture under the Workflow runtime](/docs/hook-capture-workflow-runtime.md) — Whether the measure-event store sees workflow-spawned agents, what it can and cannot attribute to an issue, and what shape the supplemental attribution record should take
