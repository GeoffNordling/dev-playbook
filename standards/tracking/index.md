...
Tracking governs how work is tracked — issue shapes, the label scheme,
and repository settings. The reasoning behind the rules is
...
- [Tracking Explanation](/standards/tracking/explanation.md) — The thinking behind the tracking rules — what a Candidate is and how it becomes an issue, the roles and relationships an issue has, the five species, what the labels mean, and why the repository settings are what they are
