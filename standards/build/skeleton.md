...
| `specs/` | Optional | governed by the [SDD standards](~/workspace/spec-tools/sdd-standards/README.md), not the OKF profile; presence activates the sdd layer ([make.md](/standards/build/make.md)) |
