...
| `docs/agents/` | Agent | Optional | Per-repo agent skill configuration: issue-tracker workflow, triage-label mapping, and domain-doc consumer rules. Generated by /setup-matt-pocock-skills. |
