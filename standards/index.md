...
- [Judgments](/standards/judgments.md) — LLM-judged assertions on files, declared in YAML, cached by content hash, proven through a pytest gate
...
- [Repo Documentation Standard](/standards/repo-documentation.md) — Content and scope of the documentation files — README, CLAUDE.md, index.md, CONTEXT.md, cross-references — and the OKF concept-doc/harness-owned bundle boundary
