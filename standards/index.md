...
- [doc-type/](/standards/doc-type/index.md) — Doc-Type governs the doc-types and the files typed by them — what any doc-type satisfies, and the form a Standard, a Runbook, a Loop, an Explanation, and a Guide take
...
- [python/](/standards/python/index.md) — Python governs how Python source is written — fail-loud code, docstrings, module layout, helpers, formatting, and type annotations
...
- [testing/](/standards/testing/index.md) — Python Testing governs how Python tests are written — the pytest framework, mirror layout, test structure, behavioral focus, doubles, and fixtures
- [tracking/](/standards/tracking/index.md) — Tracking governs how work is tracked — issue shapes, the label scheme, and repository settings
