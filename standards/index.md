...
- [distribution/](/standards/distribution/index.md) — Distribution governs how dev-playbook's checks reach the governed repos — a publisher's hook manifest and its local block, and a host's local hook and pinned dev dependency
