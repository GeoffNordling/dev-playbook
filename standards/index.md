...
- [github/](/standards/github/index.md) — GitHub governs a governed repo's repository on GitHub — its origin, its merge settings, and its protected default branch
...
- [knowledge-organization/](/standards/knowledge-organization/index.md) — Knowledge Organization governs how knowledge is organized in markdown — OKF types, indexes, the README and CONTEXT.md, cross-references, and documentation sets
...
- [shell/](/standards/shell/index.md) — Shell governs how shell is written — strict mode, declared bash, and the shellcheck and shfmt bars every file clears
...
- [tracking/](/standards/tracking/index.md) — Tracking governs how work is tracked — GitHub tracking and workstream tracking, each in its own section
