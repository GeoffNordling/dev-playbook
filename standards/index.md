...
- [docs/](/standards/docs/index.md) — The documentation-content standard, one concern per document — the OKF bundle, per-file content docs, indexes, cross-references
