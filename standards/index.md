...
(`type: Standard-Card`) and the rulesets (`type: Standard-Ruleset`) the
card's Define cell points at, and each row below carries the card's
question sentence. See
[Cells and Rulesets](/doc-types/standard/contract-shape.md). One directory,
...
- [standard/](/standards/standard/index.md) — Governs how the workspace's standards themselves are declared, found, and kept honest — the card, the catalog, the detectors, and the boundaries
