...
Guide take. The reasoning behind most of the rules is
[Doc-Type Explanation](/standards/doc-type/explanation.md); a
Standard's own rules carry their why beside them.
...
- [Doc-Type Explanation](/standards/doc-type/explanation.md) — The thinking behind the doc-type Standards — the reasons behind the rules a Standard's, a runbook's, and a loop's file each obey; Doc-Type's own rules carry their why beside them
