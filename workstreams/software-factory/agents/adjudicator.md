...
- {Read [deviation contract](~/workspace/dev-playbook/workstreams/software-factory/docs/deviation-contract.md)}
  — the **PR-callout lane**, which is the lane you work in, and the
  three-question routing test that gates every call you take.
- {Read [PR feedback](~/workspace/dev-playbook/workstreams/software-factory/docs/pr-feedback.md)} — the
...
[factory-operations.md's merge-message recipe](~/workspace/dev-playbook/workstreams/software-factory/docs/factory-operations.md#the-merge-message-recipe)}
