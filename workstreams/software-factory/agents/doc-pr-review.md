...
- {Read [review contract](~/workspace/dev-playbook/workstreams/software-factory/docs/review-contract.md)}
...
- {Read [PR feedback](~/workspace/dev-playbook/workstreams/software-factory/docs/pr-feedback.md)} —
...
2. **{Read from GitHub the repository name and the pull request's number
   ...
   contract's
   [`gh` mechanics](~/workspace/dev-playbook/workstreams/software-factory/docs/review-contract.md#the-gh-mechanics)
...
5. **{Read from GitHub the diff in scope}**, per the contract's
   [delta re-review](~/workspace/dev-playbook/workstreams/software-factory/docs/review-contract.md#delta-re-review):
...
|---|---|
| skills or agent definitions | [runbook conventions](~/workspace/dev-playbook/standards/doc-type/runbook-conventions.md) — the binding format, plus [writing for agents](~/workspace/dev-playbook/guides/writing-for-agents.md) for the craft both forms answer to; and for a factory node's agent definition or `phase:*` skill, [node-agent and skill authoring](~/workspace/dev-playbook/workstreams/software-factory/docs/node-agent-and-skill-authoring.md) on top |
...
- **The presence check**, first and mechanical. The PR body carries the
  ...
  [merge-message recipe](~/workspace/dev-playbook/workstreams/software-factory/docs/factory-operations.md#the-merge-message-recipe)
...
[thread model](~/workspace/dev-playbook/workstreams/software-factory/docs/review-contract.md#findings-are-threads),
...
[resolution ownership](~/workspace/dev-playbook/workstreams/software-factory/docs/review-contract.md#resolution-ownership).

## 5. Close

{Report `outcome` `"done"`}, per the
[report envelope](~/workspace/dev-playbook/workstreams/software-factory/docs/review-contract.md#the-report-envelope).
...
[Findings are not escalations](~/workspace/dev-playbook/workstreams/software-factory/docs/review-contract.md#findings-are-not-escalations):
