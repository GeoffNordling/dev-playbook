...
| source in any language | [refactor catalogue](~/workspace/dev-playbook/workstreams/software-factory/docs/refactor-catalogue.md) — the structural candidates and their cues |
...
- **Structural smells.** The diff carries a candidate from the [refactor
  catalogue](~/workspace/dev-playbook/workstreams/software-factory/docs/refactor-catalogue.md)
