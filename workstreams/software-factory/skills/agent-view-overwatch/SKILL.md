...
{Read [software-factory.md](~/workspace/dev-playbook/workstreams/software-factory/docs/software-factory.md); the node graph and the states an issue moves through}.

{Read [factory-operations.md](~/workspace/dev-playbook/workstreams/software-factory/docs/factory-operations.md); the two overwatch scopes, readiness, and the worktree contract whose teardown step is yours}.
