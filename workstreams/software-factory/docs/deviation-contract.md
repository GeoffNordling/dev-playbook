...
2. Does the fix touch a surface the brief withheld — a path, module, or
   ...
   ([the two headings](/standards/tracking/github/issue-shapes.md#every-build-heading-in-bold)).
...
- **A review node** — operational failures only. A problem a review can
  ...
  ([review contract](/workstreams/software-factory/docs/review-contract.md#findings-are-not-escalations)).
...
- **A suggestion disposition** — every one of them
  ([review-contract.md](/workstreams/software-factory/docs/review-contract.md#suggestion-dispositions)).
