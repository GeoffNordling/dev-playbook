...
[factory-operations.md](/workstreams/software-factory/docs/factory-operations.md#the-review-stop);
how a pull request's existing feedback is read is
[pr-feedback.md](/workstreams/software-factory/docs/pr-feedback.md).
...
2. **A named rule of a standard the review was required to read** — each
   ...
   [the merge-message recipe](/workstreams/software-factory/docs/factory-operations.md#the-merge-message-recipe)
...
- **Bad idea** — the Adjudicator is confident the change would make the work
  ...
  [the routing test](/workstreams/software-factory/docs/deviation-contract.md#the-pr-callout-lane),
...
[PR feedback](/workstreams/software-factory/docs/pr-feedback.md#the-comment-surfaces), paging and
