...
is [software-factory.md](/workstreams/software-factory/docs/software-factory.md); every point
where it stops for the user is
[user-checkpoints.md](/workstreams/software-factory/docs/user-checkpoints.md).
...
[definition](/workstreams/software-factory/docs/software-factory.md#the-definition-region) — or an
...
- A **rework** prompt carries the issue number and the id and location of every
  ...
  ([suggestion dispositions](/workstreams/software-factory/docs/review-contract.md#suggestion-dispositions)).
...
([the report envelope](/workstreams/software-factory/docs/review-contract.md#the-report-envelope)).
...
[user-checkpoints.md](/workstreams/software-factory/docs/user-checkpoints.md#escalation).
...
in [node-agent-and-skill-authoring.md](/workstreams/software-factory/docs/node-agent-and-skill-authoring.md).
...
- **Body** — mandatory sections, each checkable by absence:
  ...
  - `## Deviation ledger` — the deviation entries of the
    [deviation contract](/workstreams/software-factory/docs/deviation-contract.md#the-deviation-ledger),
...
[contract's hand-off](/workstreams/software-factory/docs/deviation-contract.md#the-deviation-ledger)
...
3. **Read the threads and compute the verdict** — the arithmetic is
   [the verdict and the cap](/workstreams/software-factory/docs/review-contract.md#the-verdict-and-the-cap),
...
thread
([resolution ownership](/workstreams/software-factory/docs/review-contract.md#resolution-ownership)),
