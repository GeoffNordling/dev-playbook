...
[factory-operations.md](/workstreams/software-factory/docs/factory-operations.md). One checkpoint
...
[Permissions](/workstreams/software-factory/docs/factory-operations.md#permissions).
...
[deviation contract](/workstreams/software-factory/docs/deviation-contract.md#escalation) —
...
[the terminal report contract](/workstreams/software-factory/docs/factory-operations.md#engagement).
...
- **Which review tracks run.** Elected from the pull request's changed files by
  [hard rule](/workstreams/software-factory/docs/factory-operations.md#track-rules), recomputed
  every cycle.
