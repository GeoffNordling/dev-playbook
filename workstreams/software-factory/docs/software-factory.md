...
- **The factory — autonomous.** Implementation in the wide sense: build, review,
  ...
  [factory-operations.md](/workstreams/software-factory/docs/factory-operations.md); every point
  where it stops is
...
[factory-operations.md](/workstreams/software-factory/docs/factory-operations.md).
