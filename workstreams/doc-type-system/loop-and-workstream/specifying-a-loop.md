...
[WORKSTREAM.md](/workstreams/doc-type-system/loop-and-workstream/WORKSTREAM.md).

## The predicate

A **predicate** is defined in [Terms](/workstreams/doc-type-system/WORKSTREAM.md#terms), and
...
objective ([Terms](/workstreams/doc-type-system/WORKSTREAM.md#terms))
