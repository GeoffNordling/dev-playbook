...
per [Fact Base Workstream](/workstreams/doc-type-system/fact-base/WORKSTREAM.md).
The answer is well-formed once stated per
[predicate](/workstreams/doc-type-system/WORKSTREAM.md#terms)
...
and view are the synthesis workstream's words
...
workstream's [Planned](/workstreams/doc-type-system/fact-base/WORKSTREAM.md#planned).
