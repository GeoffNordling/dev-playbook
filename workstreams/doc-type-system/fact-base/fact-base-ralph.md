...
simulates is
[Fact Base](/workstreams/doc-type-system/fact-base/fact-base.md). This page holds
...
and view in the synthesis workstream's
[Terms](/workstreams/doc-type-system/WORKSTREAM.md#terms),
receipt in the child workstream's
...
[envelope](/workstreams/doc-type-system/viewer/contract.md#the-envelope)
...
3. **The iteration agent.** Its behavior is a prompt string inside
   ...
   [Fact Base](/workstreams/doc-type-system/fact-base/fact-base.md#code-carries-no-prose):
