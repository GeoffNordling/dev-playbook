...
[Contract](/workstreams/doc-type-system/viewer/contract.md) and the
extractors it runs are the
[Fact Base](/workstreams/doc-type-system/fact-base/fact-base.md#extractors)
and the kinds it selects are the
[Registry](/workstreams/doc-type-system/viewer/registry.md). What
it is built with is the
[Stack](/workstreams/doc-type-system/viewer/stack.md). The parent is
