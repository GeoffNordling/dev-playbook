...
[fact base](/workstreams/doc-type-system/fact-base/fact-base.md#views-are-selections):
a selection of its nodes and edges and a renderer. Every view file a
kind produces obeys the
[Contract](/workstreams/doc-type-system/viewer/contract.md). What a
...
[Design](/workstreams/doc-type-system/viewer/design.md), and the
...
- **The other views** — the dependency graph, the data flow, the
  ...
  ([Views are selections](/workstreams/doc-type-system/fact-base/fact-base.md#views-are-selections)).
