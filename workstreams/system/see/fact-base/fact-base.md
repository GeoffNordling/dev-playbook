...
[fact base child workstream](/workstreams/system/see/fact-base/WORKSTREAM.md);
the viewer child workstream, from
[CLOA Viewer](/workstreams/system/see/viewer/WORKSTREAM.md) down,
...
| mdlink | markdown links | `links-to` edges | yes, the reference checks in `checks/knowledge_organization.py` |
...
fact base becomes a fourth place primitives get invented. A fact base
