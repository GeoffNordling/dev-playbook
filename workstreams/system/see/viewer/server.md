...
[Contract](/workstreams/system/see/viewer/contract.md) and the
extractors it runs are the
[Fact Base](/workstreams/system/see/fact-base/fact-base.md#extractors)
and the kinds it selects are the
[Registry](/workstreams/system/see/viewer/registry.md). What
it is built with is the
[Stack](/workstreams/system/see/viewer/stack.md). The parent is
