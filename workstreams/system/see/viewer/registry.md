...
([CLOA Viewer](/workstreams/system/see/viewer/WORKSTREAM.md#principles)).
Every kind is a view of the checkout's
[fact base](/workstreams/system/see/fact-base/fact-base.md#views-are-selections):
a selection of its nodes and edges and a renderer. Every view file a
kind produces obeys the
[Contract](/workstreams/system/see/viewer/contract.md). What a
...
[Design](/workstreams/system/see/viewer/design.md), and the
...
- **The other views** — the dependency graph, the data flow, the
  ...
  ([Views are selections](/workstreams/system/see/fact-base/fact-base.md#views-are-selections)).
