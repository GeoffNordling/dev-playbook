...
- F7 done: added a `transcript-export` row to the Utility scripts table in tools/README.md with purpose and command form (`<out_dir> <session_id… | --recent N | --all>`). All plan tasks complete.
