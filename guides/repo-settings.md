...
[GitHub Settings](/standards/github/settings.md).
...
2. **Set the merge settings.** In the repository's settings, give every
   row of
   [Squash-only merges](/standards/github/settings.md#squash-only-merges)
   the value that table names.
3. **Protect the default branch.** Add the ruleset that
   [Default branch protected from destructive operations](/standards/github/settings.md#default-branch-protected-from-destructive-operations)
...
4. **Mint the labels.** Run
   ...
   ([Label Scheme](/standards/tracking/github/label-scheme.md)). No label names
...
([Candidates](/standards/tracking/github/candidates.md)), and work it has
