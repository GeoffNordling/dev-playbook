...
- [Running a Stint](/guides/running-a-stint.md) — How a launching agent runs an unattended stint with the stint command — what to prepare, the one-time setup, the run and its arguments, what comes back to the repository, the stint's folder, the exit codes, and every rule that stops a stint
