...
- [Repository Settings](/guides/repo-settings.md) — How the GitHub side of a governed repo is set — the origin, the squash-only merge settings, the protect-main ruleset, the labels bootstrap-labels mints, and where a unit of work lives
