...
Headless `claude -p` draws from that same subscription pool, so a recipe may reach for it. [Headless Operation](/guides/headless.md) covers what it guarantees and what it does not.
