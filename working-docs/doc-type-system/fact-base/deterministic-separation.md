...
per [Fact Base Strand](/working-docs/doc-type-system/fact-base/ROOT.md).
The answer is well-formed once stated per
[predicate](/working-docs/doc-type-system/ROOT.md#terms)
rather than per system, and the provable part is a query over the fact
base, which is why this page sits in this strand as a planned view.

## Terms

Predicate, verifier, deterministic rule, stochastic rule, fact base,
and view are the set's words
...
root's [Planned](/working-docs/doc-type-system/fact-base/ROOT.md#planned).
