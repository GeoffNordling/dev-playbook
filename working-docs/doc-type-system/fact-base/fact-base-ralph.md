...
[fact-base-ralph.json](/working-docs/doc-type-system/fact-base/fact-base-ralph.json),
...
simulates is
[Fact Base](/working-docs/doc-type-system/fact-base/fact-base.md). This page holds
...
[Terms](/working-docs/doc-type-system/fact-base/ROOT.md#terms).
This page adds none.

## The data file

The data file obeys the
[envelope](/working-docs/doc-type-system/viewer/contract.md#the-envelope)
...
3. **The iteration agent.** Its behavior is a prompt string inside
   ...
   [Fact Base](/working-docs/doc-type-system/fact-base/fact-base.md#code-carries-no-prose):
