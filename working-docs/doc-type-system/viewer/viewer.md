...
obey the [Contract](/working-docs/doc-type-system/viewer/contract.md);
...
pin. The arrangement
([Contract](/working-docs/doc-type-system/viewer/contract.md#the-arrangement))
...
([CLOA Viewer](/working-docs/doc-type-system/viewer/ROOT.md#principles));
...
([Server](/working-docs/doc-type-system/viewer/server.md#the-command)),
