...
[fact base](/working-docs/doc-type-system/fact-base/fact-base.md#views-are-selections):
a selection of its nodes and edges and a renderer. Every view file a
kind produces obeys the
[Contract](/working-docs/doc-type-system/viewer/contract.md). What a
...
[Design](/working-docs/doc-type-system/viewer/design.md), and the
