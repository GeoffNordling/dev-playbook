...
[Contract](/working-docs/doc-type-system/viewer/contract.md) and the
extractors it runs are the
[Fact Base](/working-docs/doc-type-system/fact-base/fact-base.md#extractors)
and the kinds it selects are the
[Registry](/working-docs/doc-type-system/viewer/registry.md). What
it is built with is the
[Stack](/working-docs/doc-type-system/viewer/stack.md). The parent is
