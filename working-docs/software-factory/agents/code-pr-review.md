...
| Python source | [python style](~/workspace/dev-playbook/standards/python/style.md), plus the [module-design contract](~/workspace/dev-playbook/guides/design-and-testing.md#shaping-a-module) |
