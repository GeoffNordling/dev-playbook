...
[factory-operations.md](/working-docs/software-factory/docs/factory-operations.md#the-review-stop);
how a pull request's existing feedback is read is
[pr-feedback.md](/working-docs/software-factory/docs/pr-feedback.md).
...
2. **A named rule of a standard the review was required to read** — each
   ...
   [the merge-message recipe](/working-docs/software-factory/docs/factory-operations.md#the-merge-message-recipe)
...
- **Bad idea** — the Adjudicator is confident the change would make the work
  ...
  [the routing test](/working-docs/software-factory/docs/deviation-contract.md#the-pr-callout-lane),
...
[PR feedback](/working-docs/software-factory/docs/pr-feedback.md#the-comment-surfaces), paging and
