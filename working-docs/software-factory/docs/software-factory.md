...
- **The factory — autonomous.** Implementation in the wide sense: build, review,
  ...
  [factory-operations.md](/working-docs/software-factory/docs/factory-operations.md); every point
  where it stops is
...
([Tracking Explanation](/standards/tracking/explanation.md#candidates)). A Candidate is pre-issue:
...
[factory-operations.md](/working-docs/software-factory/docs/factory-operations.md).
