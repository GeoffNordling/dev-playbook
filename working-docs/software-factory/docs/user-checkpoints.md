...
[factory-operations.md](/working-docs/software-factory/docs/factory-operations.md). One checkpoint
...
[Permissions](/working-docs/software-factory/docs/factory-operations.md#permissions).
...
[deviation contract](/working-docs/software-factory/docs/deviation-contract.md#escalation) —
...
[the terminal report contract](/working-docs/software-factory/docs/factory-operations.md#engagement).
...
- **Which review tracks run.** Elected from the pull request's changed files by
  [hard rule](/working-docs/software-factory/docs/factory-operations.md#track-rules), recomputed
  every cycle.
