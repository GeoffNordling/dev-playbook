...
is [software-factory.md](/working-docs/software-factory/docs/software-factory.md); every point
where it stops for the user is
[user-checkpoints.md](/working-docs/software-factory/docs/user-checkpoints.md).
...
[definition](/working-docs/software-factory/docs/software-factory.md#the-definition-region) — or an
...
- A **rework** prompt carries the issue number and the id and location of every
  ...
  ([suggestion dispositions](/working-docs/software-factory/docs/review-contract.md#suggestion-dispositions)).
...
([the report envelope](/working-docs/software-factory/docs/review-contract.md#the-report-envelope)).
...
[user-checkpoints.md](/working-docs/software-factory/docs/user-checkpoints.md#escalation).
...
in [node-agent-and-skill-authoring.md](/working-docs/software-factory/docs/node-agent-and-skill-authoring.md).
...
- **Body** — mandatory sections, each checkable by absence:
  ...
  - `## Deviation ledger` — the deviation entries of the
    [deviation contract](/working-docs/software-factory/docs/deviation-contract.md#the-deviation-ledger),
...
[contract's hand-off](/working-docs/software-factory/docs/deviation-contract.md#the-deviation-ledger)
...
3. **Read the threads and compute the verdict** — the arithmetic is
   [the verdict and the cap](/working-docs/software-factory/docs/review-contract.md#the-verdict-and-the-cap),
...
thread
([resolution ownership](/working-docs/software-factory/docs/review-contract.md#resolution-ownership)),
