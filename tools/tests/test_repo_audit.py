"""Behavioral tests for tools/bin/repo-audit.
...
SCRIPT = Path(__file__).resolve().parents[1] / "bin" / "repo-audit"
CANONICAL = Path(__file__).resolve().parents[2] / "standards" / "canonical"
