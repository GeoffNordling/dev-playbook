...
simulates is
[Fact Base](/worktree-synthesis-notes-working-docs/fact-base/fact-base.md). This page holds
...
[envelope](/worktree-synthesis-notes-working-docs/viewer/contract.md#the-envelope)
...
3. **The iteration agent.** Its behavior is a prompt string inside
   ...
   [Fact Base](/worktree-synthesis-notes-working-docs/fact-base/fact-base.md#code-carries-no-prose):
