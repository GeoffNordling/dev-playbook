...
obey the [Contract](/worktree-synthesis-notes-working-docs/viewer/contract.md);
...
pin. The arrangement
([Contract](/worktree-synthesis-notes-working-docs/viewer/contract.md#the-arrangement))
...
([Server](/worktree-synthesis-notes-working-docs/viewer/server.md#the-command)),
