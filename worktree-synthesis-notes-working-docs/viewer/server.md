...
[Contract](/worktree-synthesis-notes-working-docs/viewer/contract.md) and the
extractors it runs are the
[Fact Base](/worktree-synthesis-notes-working-docs/fact-base/fact-base.md#extractors)
...
[Stack](/worktree-synthesis-notes-working-docs/viewer/stack.md). The parent is
