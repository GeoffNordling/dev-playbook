...
- **state directory** — the directory outside every repo where view files
  live
  ([the state directory](/worktree-synthesis-notes-working-docs/viewer/contract.md#the-state-directory)).
- **identity** — how a view file names a thing in a checkout
  ([identities](/worktree-synthesis-notes-working-docs/viewer/contract.md#identities)).
- **envelope** — the fixed top-level fields every view file carries
  around its payload
  ([the envelope](/worktree-synthesis-notes-working-docs/viewer/contract.md#the-envelope)).
...
- **arrangement** — what the user has open, saved per checkout
  ([the arrangement](/worktree-synthesis-notes-working-docs/viewer/contract.md#the-arrangement)).
- **refresh record** — the outcome of the last refresh for one checkout
  ([the refresh record](/worktree-synthesis-notes-working-docs/viewer/contract.md#the-refresh-record)).
...
[Live update](/worktree-synthesis-notes-working-docs/viewer/server.md#live-update)
targets.
...
- **The objects are already defined; the viewer only draws them.** A
  ...
  ([Fact Base](/worktree-synthesis-notes-working-docs/fact-base/fact-base.md#the-objects-are-already-defined)).
...
- [Contract](/worktree-synthesis-notes-working-docs/viewer/contract.md) — the
  state directory, view file paths, identities, the envelope, the
  arrangement, the refresh record, and the failure rules.
- [Registry](/worktree-synthesis-notes-working-docs/viewer/registry.md) — what
  a registry entry is, the kinds built, and the kinds deferred.
- [Design](/worktree-synthesis-notes-working-docs/viewer/design.md) — how a
  panel is designed, and the renderer ideas recorded for the runbook
  views.
- [Viewer](/worktree-synthesis-notes-working-docs/viewer/viewer.md) — the page
  in the browser: layout, tree, panels, toggle, refresh, and failure on
  screen.
- [Server](/worktree-synthesis-notes-working-docs/viewer/server.md) — the
  command, the server's jobs, and live update.
- [Stack](/worktree-synthesis-notes-working-docs/viewer/stack.md) — the two
...
- **Runbook design** — a design session for the runbook views, starting
  ...
  [Design](/worktree-synthesis-notes-working-docs/viewer/design.md): the
