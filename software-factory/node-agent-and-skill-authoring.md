...
- **A node stages scratch outside the repository.** Intermediate text — a comment body, a PR description — is written to `/tmp/<kind>-<issue>.md` and passed with `--body-file`. The worktree holds the deliverable and nothing else.
