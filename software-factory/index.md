...
- [Git Authority](/software-factory/git-authority.md) — The layers deciding which git operations an agent may run, the push rule family, and the canonical command set
