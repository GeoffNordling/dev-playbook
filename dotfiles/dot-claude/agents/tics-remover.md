...
{Read [slop-tics.md](~/workspace/dev-playbook/guides/slop-tics.md)}, then {Write the
...
{Read [writing-for-agents.md](~/workspace/dev-playbook/guides/writing-for-agents.md)},
