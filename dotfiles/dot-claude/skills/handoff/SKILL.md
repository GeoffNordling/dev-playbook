...
Compact this conversation into a document a fresh agent resumes from, saved to the OS temporary directory, not the workspace. `$ARGUMENTS`, when present, names what the next session will focus on; tailor the document to it.
