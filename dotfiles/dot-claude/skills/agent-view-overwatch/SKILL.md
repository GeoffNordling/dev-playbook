...
2. **Recommend the next launch.** An issue is launchable when it is unblocked per factory-operations.md's readiness rule; among the launchable, recommend what to launch next and say why — dependency order, a verdict waiting, work going stale.
