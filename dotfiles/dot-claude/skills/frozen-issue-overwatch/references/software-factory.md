...
- **The factory — autonomous.** Implementation in the wide sense: build, review,
  ...
  [factory-operations.md](~/.claude/skills/frozen-issue-overwatch/references/factory-operations.md); every point
  where it stops is
...
[factory-operations.md](~/.claude/skills/frozen-issue-overwatch/references/factory-operations.md).
