...
[factory-operations.md](~/.claude/skills/frozen-issue-overwatch/references/factory-operations.md#the-review-stop);
how a pull request's existing feedback is read is
[pr-feedback.md](~/.claude/skills/frozen-issue-overwatch/references/pr-feedback.md).
