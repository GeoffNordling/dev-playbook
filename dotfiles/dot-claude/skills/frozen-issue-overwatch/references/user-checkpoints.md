...
[factory-operations.md](~/.claude/skills/frozen-issue-overwatch/references/factory-operations.md). One checkpoint
...
[Permissions](~/.claude/skills/frozen-issue-overwatch/references/factory-operations.md#permissions).
...
[deviation contract](~/.claude/skills/frozen-issue-overwatch/references/deviation-contract.md#escalation) —
...
must emit — are
[the terminal report contract](~/.claude/skills/frozen-issue-overwatch/references/factory-operations.md#engagement).
