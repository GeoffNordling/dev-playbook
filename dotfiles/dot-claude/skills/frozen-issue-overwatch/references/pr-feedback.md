...
[review contract](~/.claude/skills/frozen-issue-overwatch/references/review-contract.md) to learn how to read a
pull request.
...
[deviation contract](~/.claude/skills/frozen-issue-overwatch/references/deviation-contract.md).
