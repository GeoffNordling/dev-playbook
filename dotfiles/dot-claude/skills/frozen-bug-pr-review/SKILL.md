...
Read [the review contract](~/.claude/skills/frozen-issue-overwatch/references/review-contract.md)
...
comment on the PR
([the review contract](~/.claude/skills/frozen-issue-overwatch/references/review-contract.md#the-findings-comment)).
...
- **Rank findings most-severe first.** Each finding: `file:line`, its
  ...
  [the review contract](~/.claude/skills/frozen-issue-overwatch/references/review-contract.md#anchoring).
...
[Findings are not escalations](~/.claude/skills/frozen-issue-overwatch/references/review-contract.md#findings-are-not-escalations):
