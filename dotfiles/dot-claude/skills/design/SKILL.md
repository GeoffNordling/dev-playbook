...
4. Report and stop:
   ...
   ```
   Where §5 opened a tree, append ` · prototype/<issue> unpushed` — the pending push stated as a flag for the overwatch, never as a step ([node-skill authoring](~/workspace/dev-playbook/software-factory/node-skill-authoring.md#mechanics)).
