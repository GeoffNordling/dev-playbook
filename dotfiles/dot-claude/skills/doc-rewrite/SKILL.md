---
name: doc-rewrite
description: Rewrite a Markdown document from scratch, rebuilding its structure while preserving content by default. Use when the user asks to rewrite a Markdown document rather than edit it in place.
