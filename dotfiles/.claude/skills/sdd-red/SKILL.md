...
- [SDD standards index](~/workspace/dev-playbook/sdd-standards/README.md) — the reading list of standards files plus the [spec standard](~/workspace/dev-playbook/sdd-standards/spec-standard.md), including its [anatomy of a spec item](~/workspace/dev-playbook/sdd-standards/spec-standard.md#2-anatomy-of-a-spec-item). For the `Interface:` keyword specifically (names the test targets), see [spec-standard.md — Interface](~/workspace/dev-playbook/sdd-standards/spec-standard.md#69-interface).
