...
- [Sandbox measurement options](/sandbox_probe/MEASUREMENT-OPTIONS.md) — The options for carrying a sandboxed run's hook events into the host measurement store — what is rejected and why, and the one option left standing
