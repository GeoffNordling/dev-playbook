...
- [Residual Ledger](/no-more-slop-branch-working-files/RESIDUAL-LEDGER.md) — Per unit, what its full rewrite could not express in the edge-encoding map — each entry awaiting a verdict
