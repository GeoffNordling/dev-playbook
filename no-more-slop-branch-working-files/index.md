...
- [Edge Encoding](/no-more-slop-branch-working-files/EDGE-ENCODING.md) — The inline grammar that makes skill prose machine-parseable — the rules ruled so far and the roster of edges still to encode
